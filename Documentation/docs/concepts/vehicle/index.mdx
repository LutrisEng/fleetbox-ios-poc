...
<Image
  img={require("./landing.jpg")}
  alt="The screen seen immediately after selecting a vehicle in Fleetbox"
/>
...
<Image img={require("./details.jpg")} alt="A Fleetbox vehicle's details list" />
...
<Image
  img={require("./odometer.jpg")}
  alt="A screenshot of the Fleetbox odometer details screen"
/>
...
<Image
  img={require("./warranties.jpg")}
  alt="A screenshot of a Fleetbox vehicle's warranties section"
/>

## Attachments

<Image
  img={require("./attachments.jpg")}
  alt="A screenshot of a Fleetbox vehicle's attachments section"
/>
...
<Image
  img={require("./log.jpg")}
  alt="A screenshot of a Fleetbox vehicle's maintenance log"
/>
